...
<>
  <nav className="bg-pink-500">
    <div className="flex items-center space-x-8 py-[1.3rem] px-4 max-w-screen-2xl mx-auto md:px-8">
  ...
  <section className="bg-pink-300 h-[100rem] ">
    <div className="flex flex-col items-center px-6 py-8 mx-auto md:h-[53.2rem]">
      <div className="w-full bg-white rounded-lg shadow dark:border md:mt-56 sm:max-w-md xl:p-0 p-4">
