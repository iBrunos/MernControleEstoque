...
const updateService = (id, product, observation, amount, entry_price, inserted_by, payment, store, type) => Exit.findOneAndUpdate({_id: id}, {product, observation, amount, entry_price, inserted_by, payment, store, type });
